...
class NavigationService(
	...
	fun stop(): Map<String, Any?> {
		...
		val stopCommands = listOf(
			ros.call("publish_once", mapOf("topic" to properties.topics.cmdVel, "msg_type" to "geometry_msgs/msg/Twist", "msg" to zeroTwist)),
			ros.call("publish_once", mapOf("topic" to properties.topics.baseCmdVel, "msg_type" to "geometry_msgs/msg/Twist", "msg" to zeroTwist)),
		)
